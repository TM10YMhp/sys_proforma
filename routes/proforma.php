...
Route::prefix('proformas')->group(function () {
  ...
  Route::get('/edit/{product}', [ProformaController::class, 'edit'])->name('proformas.edit');
  Route::put('/{product}', [ProformaController::class, 'update'])->name('proformas.update');
  Route::delete('/{product}', [ProformaController::class, 'destroy'])->name('proformas.destroy');
});
